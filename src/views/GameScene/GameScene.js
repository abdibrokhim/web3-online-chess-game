...
/***********************************************************************************************/
    ...
    getWidthHeight(aspect) {
        ...
        const preWidth = aspect * innerHeight;
        if (preWidth > innerWidth) {
          return { width: innerWidth, height: innerWidth / aspect };
        }
        return { width: preWidth, height: innerHeight };
    }
    ...
    render() {
        return (
          <div className="GameScene">
            ...
            <div className="metamask-wallet-connect" style={{ padding: "10px", textAlign: "center" }}>
                {!this.state || !this.state.wallet ? (
                <button onClick={this.connectWalletPressed}>
                    Connect Wallet
                </button>
                ) : (
                <p>Wallet Connected: {this.state.wallet}</p>
                )}
            </div>
